...
class __TwigTemplate_9fd593d233d233b83e9ba95cb35731aa extends Template
{
    private $source;
    private $macros = [];
...
<html";
  ...
  <body";
    ...
    ";
        // line 51
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->extensions['Drupal\Core\Template\TwigExtension']->withoutFilter($this->sandbox->ensureToStringAllowed(($context["page_top"] ?? null), 51, $this->source), "gin_secondary_toolbar"), "html", null, true);
        echo "
    ";
        // line 52
...
";
    ...
    {
        return new Source("", "themes/contrib/gin/templates/html.html.twig", "/var/www/html/Tech_ocean/web/themes/contrib/gin/templates/html.html.twig");
    }
